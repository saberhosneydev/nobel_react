...
export default function About() {
    return (
        <><Head>
            <title>About</title>
        </Head><div className="mt-8 mb-16 mx-auto text-gray-700 max-w-4xl space-y-6 text-lg">
                <div>
                ...
                <div>
                    ...
                    <ul className="list-disc list-inside ml-1 my-2">
                        <li><a className="text-blue-600 underline" href="https://www.github.com/saberhosneydev" target="_blank" rel="noreferrer noopener external">@saberhosneydev</a></li>
                    </ul>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p className="my-2 ml-1">
                        Due to the nature of the nobel prize data that changes biannually/yearly.this project uses a snapshot of the data provided by <a className="text-blue-600 underline" href="https://www.nobelprize.org/about/developer-zone-2/" rel="noreferrer noopener" target="_blank">NobelPrize API</a>
                ...
                <div>
                    ...
                    <p className="my-2 ml-1">
                        this website may contains copyrighted work, all the copyright to the materials shown here is due to it&apos; s original copyright holder <a className="text-blue-600 underline" href="https://www.nobelprize.org/" rel="noreferrer noopener" target="_blank">NobelPrize</a>
                    </p>
                </div>
                <div>
                    ...
                    <p className="my-2 ml-1">
                        All feedback and issues are encouraged and can be submitted as <a className="text-blue-600 underline" href="https://github.com/saberhosneydev/nobel_react/issues" target="_blank" rel="noreferrer noopener external">github issue</a><br>
